...
def extract_voice_from_file(file_path):
    ...
    voice_segment.export("tranlated_voices/extracted_voice.wav", format="wav")

    return "tranlated_voices/extracted_voice.wav"
...
def destination_language():
    ...
    while True:
        ...
        r = sr.Recognizer()
        with sr.AudioFile("tranlated_voices/extracted_voice.wav") as source:
            try:
...
extracted_voice_file = extract_voice_from_file("tranlated_voices/recorded_voice_adjusted.mp3")
